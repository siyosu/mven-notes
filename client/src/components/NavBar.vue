...
<template>
  <nav
    class="absolute right-0 top-full mt-2 rounded-md border bg-background p-2 transition sm:static sm:translate-x-0 sm:border-none sm:p-0"
    :class="show ? 'translate-x-0' : 'translate-x-[150%]'"
  >
